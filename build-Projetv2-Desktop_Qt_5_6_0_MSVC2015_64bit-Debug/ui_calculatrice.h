...
"QPushButton:hover{background-color:rgb(101, 161, 198)}"));
        ...
        gridLayoutWidget_3->setGeometry(QRect(0, 390, 361, 171));
...
"QPushButton:hover{background:rgb(72, 72, 72);}"));
        ...
        affPile->setGeometry(QRect(360, 40, 201, 521));
        QFont font3;
...
"QPushButton:hover{background:rgb(72, 72, 72);}"));
        ...
        editProg->setGeometry(QRect(780, 40, 321, 281));
        ...
        nameProg->setGeometry(QRect(780, 360, 261, 41));
        ...
        affVar->setGeometry(QRect(560, 40, 111, 521));
...
"QListWidget::item::hover{background:red;}"));
        ...
        affVal->setGeometry(QRect(670, 40, 111, 521));
...
"QListWidget::item::hover{background:red;}"));
        ...
        label_5->setGeometry(QRect(780, 400, 321, 41));
...
"QPushButton:hover{background:rgb(72, 72, 72);}"));
        ...
        label_6->setGeometry(QRect(780, 320, 321, 41));
