...
public:
    ...
    */
    const string toString() const {
        if (expr.length() > 20)
            return string(expr.begin(), expr.begin() + 16) + "...'";
        else
            return expr;
    }
    /*!
...
public:
    ...
    */
    const string toString() const {
        if (prog.length() > 20)
            return(string(prog.begin(), prog.begin() + 16) + "...]");
        else
            return prog;
    }
    /*!
...
public:
    ...
    *  \brief Redefinition de la fonction d'affichage
    */
    const string toString() const { string s = to_string(val);  const char*t = s.c_str(); qWarning(t); return s; }
    /*!
...
public:
    ...
    *  \brief Redefinition de la fonction d'affichage
    */
    const string toString() const { return(to_string(num.getVal()) + "/" + to_string(den.getVal())); }
    /*!
    *  \brief Redefinition de la fonction de clonage
    */
